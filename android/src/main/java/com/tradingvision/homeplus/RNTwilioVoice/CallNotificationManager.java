    ...
    public void createMissedCallNotification(ReactApplicationContext context, String callSid, String callFrom) {
        ...
        PendingIntent clearMissedCallsCountPendingIntent = PendingIntent.getBroadcast(
                ...
                new Intent(Constants.ACTION_CLEAR_MISSED_CALLS_COUNT)
                        .putExtra(Constants.INCOMING_CALL_NOTIFICATION_ID,
                                Constants.CLEAR_MISSED_CALLS_NOTIFICATION_ID),
                0);
        /*
         * Pass the notification id and call sid to use as an identifier to open the
         * notification
         */
        ...
        if (missedCalls == 1) {
            ...
            inboxStyle.setBigContentTitle(
                    String.valueOf(missedCalls) + " " + context.getString(R.string.call_missed_title_plural));
        }
