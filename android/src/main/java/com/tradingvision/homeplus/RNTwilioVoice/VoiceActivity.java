...
public class VoiceActivity extends AppCompatActivity {
    ...
    public String accessToken; //this will set by twilioVoiceModule which inherit the ReactContextBaseJavaModule
...
//                }
    ...
    public void registerForCallInvites() {
        ...
        FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(this, instanceIdResult -> {
            ...
            Log.i(TAG, "Registering with FCM, accessToken:" + accessToken);
...
//            registerForCallInvites();
            Log.i(TAG, "permission for audio and bluetooth is already granted");
        }
    }
...
//                startAudioSwitch();
//                registerForCallInvites();
                Log.i(TAG, "permission for audio is granted");
            }
        }
    }
