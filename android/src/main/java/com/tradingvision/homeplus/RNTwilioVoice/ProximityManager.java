...
import static com.tradingvision.homeplus.RNTwilioVoice.EventManager.EVENT_PROXIMITY;
...
public class ProximityManager {
    ...
    private void initProximityWakeLock() {
        // Check if PROXIMITY_SCREEN_OFF_WAKE_LOCK is implemented, not part of public
        // api.
        // PROXIMITY_SCREEN_OFF_WAKE_LOCK and isWakeLockLevelSupported are available
        // from api 21
        try {
            boolean isSupported;
