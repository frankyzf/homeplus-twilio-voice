...
public class Constants {
    ...
    public static final String ACTION_ACCEPT = "com.tradingvision.homeplus.RNTwilioVoice.ACTION_ACCEPT";
    public static final String ACTION_REJECT = "com.tradingvision.homeplus.RNTwilioVoice.ACTION_REJECT";
